...
const localeNotesList = [
    {
        ...
        categoryUuid: '2b2a6ee6-11f5-42c2-8c42-7e92f5655648',
    ...
    },
    {
        ...
        categoryUuid: 'b37e8534-0492-431b-9ecb-a97caf40f350',
    ...
    },
    {
        ...
        categoryUuid: '8c64ef70-55db-4625-bc36-86be7e0fd1c6',
...
const remoteNotesList = [
    {
        uuid:       'ba31020c-77b7-4c4e-85dd-acb00e781031',
        categoryUuid: '48fefcf1-e3c0-4645-b7e9-91007cbf0b4b',
    ...
    },
    {
        ...
        categoryUuid: 'e22345a0-58c9-43e7-b4eb-9646aef53996',
...
const result = {
    updateOperations: [
        {action: UPDATE_NEW_NOTE_OPERATION, isFromLocalStore: true, uuid: 'ba31020c-77b7-4c4e-85dd-acb00e781031'},
        {action: ADD_NEW_NOTE_OPERATION, isFromLocalStore: true, uuid: 'b5c968df-f0b2-4ac9-8aa0-228b9d4be280'},
        {action: ADD_NEW_NOTE_OPERATION, isFromLocalStore: false, uuid: '934bd087-842a-4285-89e6-f7d70b2dd8b8'},
        {action: ADD_NEW_NOTE_OPERATION, isFromLocalStore: false, uuid: 'ae141995-df1e-468a-bda7-964533aedc2e'},
    ],
    mergedIndex: [
        ...remoteNotesList,
...
const result2 = {
    updateOperations: [
        {action: ADD_NEW_NOTE_OPERATION, isFromLocalStore: true, uuid: 'b5c968df-f0b2-4ac9-8aa0-228b9d4be280'},
        {action: UPDATE_NEW_NOTE_OPERATION, isFromLocalStore: false, uuid: 'ba31020c-77b7-4c4e-85dd-acb00e781031'},
        {action: ADD_NEW_NOTE_OPERATION, isFromLocalStore: false, uuid: '934bd087-842a-4285-89e6-f7d70b2dd8b8'},
        {action: ADD_NEW_NOTE_OPERATION, isFromLocalStore: false, uuid: 'ae141995-df1e-468a-bda7-964533aedc2e'},
    ],
    mergedIndex: [
