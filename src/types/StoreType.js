...
export type StoreType = {
    ...
    saveNotesList: (data: Array<NoteType>, error: (err: Error) => void, success: () => void, loader: (isLoading: boolean) => void) => void,
    ...
    saveNote: (note: NoteType, error: (err: Error) => void, success: () => void, createNoteDir: boolean, loader: (isLoading: boolean) => void,) => void,
